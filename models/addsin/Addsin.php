...
class BdAddsIn {
    ...
    function addAddsIn($designation) {
        try {
            $bd = Connexion::connecter();
            $query = $bd->prepare("INSERT INTO addsin(designation) VALUES(?)");
    ...
    function getAddsInAll() {
        $bd = Connexion::connecter();
        $reponse = $bd->query("SELECT * FROM addsin ORDER BY id DESC");
