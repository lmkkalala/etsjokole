...
class BdAttributionBiens {
    ...
    function select($table,$field,$idbiens) {
        $bd = Connexion::connecter();
        $reponse = $bd->query("SELECT * FROM $table WHERE $field='{$idbiens}' ORDER BY id DESC");
        return $reponse->fetchAll();
        $reponse->closeCursor();
    }
