...
if (isset($_POST['bt_enregistrer'])) {
    ...
    if (1) {
        ...
        header('Location:../../views/home.php?link=' . sha1("admin_fonction_add") . '&link_up=' . sha1("home_admin_fonctionM") . '&reponse=' . sha1($reponse));
        die;
    }
}
...
if (isset($_POST['bt_modifier'])) {
    ...
    header('Location:../../views/home.php?link=' . sha1("admin_fonction_update_fonction_all") . '&link_up=' . sha1("home_admin_fonctionM") . '&reponse=' . sha1($reponse));
    die;
}
...
if (isset($_POST['bt_active'])) {
    ...
    header('Location:../../views/home.php?link=' . sha1("admin_fonction_active_fonction_all") . '&reponse=' . sha1($reponse).'&link_up='.sha1("home_admin_fonctionM"));
}
