...
<div class="panel">
    ...
    <div class="panel panel-body">
        <div>
            <fieldset>
                <legend>Les catégories enregistrées</legend>
                <?php
                ...
                <table class="table table-bordered table-responsive-lg">
                    ...
                    <tbody>
                        ...
                        foreach ($categories as $categorie) {
                            $n++;
                            ?>
                        <form class="form-horizontal" method="POST" action="../contollers/categorie/categorieController.php">
                            <div class="form-group-lg">
                                <tr>
                                    <td><?= $categorie['id'] ?></td>
                                    <td><input class="form-control" type="text" name="tb_designation" value="<?= $categorie['designation'] ?>"></td>
