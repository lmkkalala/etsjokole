            ...
            <div class="row">
                <div id="menu-gauche" class="col-lg-2 col-md-2">
                    <ul class="list-menu list-unstyled" style="font-size: 20px;">
                        <li class="list-inline-item"><span style="color: orange;font-size: 20px;" class="glyphicon glyphicon-list"></span><a href="/views/home.php?link=<?= sha1("service_reception_liste_reception_all") ?>&link_up=<?= sha1("home_service_reception") ?>">Report</a></li>
                        <li class="list-inline-item"><span style="color: darkslategray;font-size: 20px;" class="fa fa-file-text"></span><a href="/views/home.php?link=<?= sha1("service_reception_fiche_biens_reception_all") ?>&link_up=<?= sha1("home_service_reception") ?>">Lister Par Item</a></li>
