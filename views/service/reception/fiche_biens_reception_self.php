...
<div class="panel">
    <div class="panel panel-heading">
        ...
        <span class="h3">Les réceptions</span>
        <span class="glyphicon glyphicon-chevron-right" style="color: black; font-size: 30px;margin-right: 5px;"></span>
        <span class="fa fa-share-alt" style="color: forestgreen; font-size: 30px;margin-right: 5px;"></span>
        <span class="fa fa-file-text-o" style="color: forestgreen; font-size: 30px;margin-right: 5px;"></span>
        <span class="h4">Fiche de réceptions pour un biens/produit</span>
    </div>
    <div class="panel panel-body">
        <div>
            ...
            <fieldset>
                <legend>Fiche des réceptions d'un biens/produit</legend>
                <?php
                include 'liste_reception_by_idbiens.php';
                ?>
            </fieldset>
        </div>
    </div>
