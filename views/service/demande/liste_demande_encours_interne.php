...
<div class="panel">
    <div class="panel panel-heading">
        ...
        <span class="h4">Liste des demandes encours en interne</span>
    </div>
            ...
            <fieldset>
                ...
                <table class="table table-bordered table-responsive-lg">
                    ...
                    <tbody>
                        ...
                        $demandes = $bddemande->getDemandeAllDescEncoursInterne();
                        foreach ($demandes as $demande) {
                            if (($demande['sId'] == $_SESSION['idservice'])) {
                                ...
                                <tr>
                                    ...
                                    <?php
                                    if (($demande['qualiteDemandeur'] == "membre") && ($_SESSION['type'] == "other")) {
                                        ?>
                                        <td>
                                            <form class="form-horizontal" method="POST" action="../contollers/demande/demandeController.php">
                                                <input type="hidden" name="tb_id_demande" value="<?= $demande['dId'] ?>">
                                                <button class="btn btn-success" type="submit" name="bt_finalise_distribution"><span class="fa fa-check"></span></button>
                                            </form>
                                        </td>
                                        <?php
                                    }
