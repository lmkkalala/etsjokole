...
<div class="panel">
    ...
    <div class="panel panel-body">
        <div>
            <fieldset>
                <legend>Liste de produits</legend>
                <?php
                                ...
                                <td>
                                    ...
                                    if (1) {
                                        ...
                                        <form method="post" action="../contollers/production/productionController.php">
                                            ...
                                            <button type="submit" name="bt_select_nourriture" class="btn btn-primary"><span class="glyphicon glyphicon-chevron-right" style="color: white; font-size: 15px;margin-right: 5px;"></span></button>
                                        </form>
                                        <?php
                                    } ?>
                                </td>
