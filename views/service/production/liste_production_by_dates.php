...
<div class="panel" style="padding:10px;">
    <div class="panel panel-heading">
        ...
        <span class="glyphicon glyphicon-open-file" style="color: orange; font-size: 30px;margin-right: 5px;"></span>
        <span class="h4">Production par dates</span>
    </div>
                    ...
                    <tr>
                        ...
                        <td style="padding-left: 8px;">
                            <div class="form-group-lg">
                                ...
                                <button type="submit" class="btn btn-success" name="bt_select_dates_all"><span class="glyphicon glyphicon-search" style="color: white; font-size: 30px;margin-right: 5px;"></span></button>
                    ...
                    <tbody>
                        ...
                        foreach ($productions as $production) {
                            ...
                            <tr>
                                ...
                                ?>
                                <td style="font-weight: 700; color: dodgerblue;"><?= ($production['quantite']-$cumulQuantiteLS) ?></td>
                                <td>
                                    <?php
