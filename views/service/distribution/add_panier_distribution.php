            ...
            <form class="form-horizontal" method="POST" action="../contollers/distribution/distributionController.php">
                <div>
                    <fieldset>
                        <div class="form-group-lg">
                            <div class="input-group-lg">
                                ...
                                <select class="form-control" name="cb_distribution" id="cb_distribution1">
                    ...
                    <fieldset>
                        <legend></legend>
                        <div class="input-group-lg">
                            <input type="hidden" name="tb_idaffectation" id="tb_idaffectation1"  value="<?= $_SESSION['idaffectation'] ?>">
                            <input type="hidden" name="tb_use_date" id="tb_use_date1" value="<?= $_GET['use_date'] ?>">
                            <input type="hidden" name="tb_use_typerepas" id="tb_use_typerepas1" value="<?= $_GET['use_typerepas'] ?>">
                            <input type="hidden" name="tb_use_identiteClient" id="tb_use_identiteClient1" value="<?= $_GET['use_identiteClient'] ?>">
                            <input type="hidden" name="tb_use_ventePOS" id="tb_use_ventePOS1" value="<?= $_GET['use_ventePOS'] ?>">
