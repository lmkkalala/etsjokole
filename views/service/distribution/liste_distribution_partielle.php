...
<div class="panel">
    <div class="panel panel-heading">
        ...
        <span class="glyphicon glyphicon-time" style="color: #0069d9; font-size: 30px;margin-right: 5px;"></span>
        <span class="h4">Liste des distributions partielles / non récupérées</span>
    </div>
    <?php
    $link = "service_distribution_liste_distribution_partielle";
