...
<table id="listdatabyid" class="display nowraptable table-bordered table-responsive-lg">
    <thead>
        <tr>
            <th>
                N°
    ...
    <tfoot>
        <tr>
            ...
            <th style="font-size: 20px; color: forestgreen; font-weight:bold;">
                <span>Valeur total (USD): </span><span><?= $cumulValeur ?></span>
            </th>
            <th style="font-size: 20px; color: orange; font-weight:bold;">
                <span>Qte: </span><span><?= $cumulQty ?></span>
            </th>
            <th style="font-size: 20px; color: dodgerblue; font-weight:bold;">
                <?php
                    $cmPrix=0;
                    $nRav=0;
                    $meanPrice=0;
            ...
            <th style="font-size: 20px; color: darkred; font-weight:bold;">
                <span>
