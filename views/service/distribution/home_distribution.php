            ...
            <div class="row">
                <div id="menu-gauche" class="col-lg-2 col-md-2">
                    <ul class="list-menu list-unstyled" style="font-size: 20px;">
                        ...
                        <li class="list-inline-item"><span style="color: orange;font-size: 20px;" class="fa fa-file-text"></span><a href="/views/home.php?link=<?= sha1("fiche_biens_vente")?>&link_up=<?= sha1("home_service_distribution")?>">Rapport GLOBAL</a></li>
                        <li class="list-inline-item"><span style="color: darkslategray;font-size: 20px;" class="fa fa-gift"></span><a href="/views/home.php?link=<?= sha1("service_distribution_fiche_biens_distribution_all")?>&link_up=<?= sha1("home_service_distribution")?>">Fiche de ventes par biens/produit</a></li>
                        <li class="list-inline-item"><span style="color: #0069d9;font-size: 20px;" class="fa fa-user"></span><a href="/views/home.php?link=<?= sha1("service_distribution_fiche_agent_distribution_all")?>&link_up=<?= sha1("home_service_distribution")?>">Fiche de ventes par agent</a></li>
