...
<legend></legend>
<div class="input-group-lg">
    <input class="btn btn-success" type="submit" name="bt_select_customer_dates_list" value="Selectionner">
...
?>
<p>
    <strong style="color: #0080c0;">Selected customer : <?= $info_customer; ?>
    <hr>
    Dates : <?= $_GET['use_date1']." to ".$_GET['use_date2']; ?></strong>
</p>
<?php
}
...
$itmsDateSale=explode(" ",$sale['dateEnreg']);

if ((isset($_GET['use_date1'])) && ($_GET['use_date1']!="" && $_GET['use_date2']) && ($itmsDateSale[0]>=$_GET['use_date1'] && $itmsDateSale[0]<=$_GET['use_date2'])) {
        ...
        ?>
                            ...
                            <td>
                                <div class="input-group-lg">
                                    ...
                                    <input class="form-control" type="hidden" name="tb_saleId" value="<?= $sale['id']; ?>">
                                    <?php
                                        if (isset($_GET['use_customer'])) {
                                            ?>
