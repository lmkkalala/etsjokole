...
?>
    ...
    <div id="menu2-a" class="col-lg-12 col-md-12 col-sm-12">
        <ul class="nav nav-tabs nav-justified">
            ...
            <li role="presentation"><a class="btn btn shadow-none text-uppercase fw-bolder" style="font-size: 15px; color: #000e1f;" href="/views/home.php?link=<?= sha1("service_distribution_liste_distribution_all")?>&link_up=<?= sha1("home_service_distribution")?>"><span class="fa fa-dollar" style="margin: 10px;"></span>vente</a></li>
            <li role="presentation"><a class="btn btn shadow-none text-uppercase fw-bolder" style="font-size: 15px; color: #000e1f;" href="/views/home.php?link_up=<?= sha1('home_service_annulation'); ?>"><span class="fa fa-undo" style="margin: 10px;"></span>Vente annulees</a></li>
            ...
            <li role="presentation"><a class="btn btn shadow-none text-uppercase fw-bolder" style="font-size: 15px; color: #000e1f;" href="/views/home.php?link_up=<?= sha1('home_logistique_bordereau_expedition'); ?>"><span class="fa fa-book" style="margin: 10px;"></span>Bordereau</a></li>
