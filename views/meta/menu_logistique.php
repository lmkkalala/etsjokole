...
?>
    <div id="menu2-a" class="col-lg-12 col-md-12 col-sm-12">
        <ul class="nav nav-tabs nav-justified">
            <li role="presentation"><a class="btn btn-primary text-white shadow-none text-uppercase fw-bolder" style="font-size: 15px;" class="active" href="/views/home.php?link_up=<?= sha1('home_logistique_acceuil'); ?>"><span class="fa fa-home" style="margin: 3px;"></span>Accueil</a></li>
            ...
            <li role="presentation"><a class="btn btn shadow-none text-uppercase fw-bolder" style="font-size: 15px;" href="/views/home.php?link_up=<?= sha1('home_logistique_fournisseur'); ?>"><span class="fa fa-user" style="color: #0069d9;margin: 10px;"></span>fournisseur</a></li>
            ...
            <li role="presentation"><a class="btn btn shadow-none text-uppercase fw-bolder" style="font-size: 15px;" href="/views/home.php?link_up=<?= sha1('home_logistique_caisse'); ?>"><span class="fa fa-money" style="color: #0069d9;margin: 10px;"></span>Caisses</a></li>
            <li role="presentation"><a class="btn btn shadow-none text-uppercase fw-bolder" style="font-size: 15px;" href="/views/home.php?link_up=<?= sha1('home_logistique_dette'); ?>"><span class="fa fa-minus-square" style="color: #0069d9;margin: 10px;"></span>Dettes</a></li>
            <li role="presentation"><a class="btn btn shadow-none text-uppercase fw-bolder" style="font-size: 15px;" href="/views/home.php?link_up=<?= sha1('home_logistique_taux'); ?>"><span class="fa fa-exchange" style="color: #0069d9;margin: 10px;"></span>Devise</a></li>
