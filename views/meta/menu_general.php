                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-12">
                            <form method="post" action="../contollers/logout/logoutController.php">
                                <button type="submit" name="bt_deconnexion" class="btn btn bg-white text-primary mt-1">
                                    <i class="fa fa-sign-out" aria-hidden="true"></i>
                                </button>
                            </form>
                        </div>
                        <div class="col-md-2 col-sm-12">
                            <button type="button" class="btn btn bg-white text-primary mt-1" id="toggle_menu">
