                                                                                                                                                                        ...
                                                                                                                                                                        <div class="container-fluid">
                                                                                                                                                                            <div class="row">
                                                                                                                                                                                ...
                                                                                                                                                                                <div class="col-md-3 mt-4">
                                                                                                                                                                                    <p class="text-end h5 bg-secondary text-white p-1 text-center w-75"> Le <?=date('d-m-Y',time())?></p>
                                                                                                                                                                                </div>
                                                                                                                                                                                <div class="row">
                                                                                                                                                                            ...
                                                                                                                                                                            <div class="row">
                                                                                                                                                                                ...
                                                                                                                                                                                <div class="col-md-12">
                                                                                                                                                                                    <form action="" method="post" id="add_vente">
                                                                                                                                                                                        <div class="row mt-2">
                                                                                                                                                                                            <div class="col-md-3 mt-1">
                                                                                                                                                                                                <input type="hidden" id="dateVente" name="dateVente" class="form-control" value="">
                                                                                                                                                                            ...
                                                                                                                                                                            $.ajax({
                                                                                                                                                                                ...
                                                                                                                                                                                success: function(data){
                                                                                                                                                                                    ...
                                                                                                                                                                                    if (data.htmlArticle.OptionDepot != '') {
                                                                                                                                                                                        $('#OptionDepotDeS').html(data.htmlArticle.OptionDepot)
                                                                                                                                                                                    }
