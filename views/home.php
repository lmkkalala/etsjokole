            ...
            <div class="row fixed-bottom bg-white" style="height: auto;">
                <div class="col-md-4 col-sm-12 mt-3">
                    <span style="color: #0069d9;font-size: 15px;margin: 10px;">
                        <p class="mx-2">
                            Designed by <b>Rifin Ashuza K.</b>
                            <span class="fa fa-copyright pull-left" style="color: #0069d9; font-size: 30px;margin-right: 5px;"></span> 
                        </p>
                        <p class="mx-2 fw-bolder"><i class="fa fa-envelope-open fw-bolder"></i> rifinashuza.kuderha@gmail.com</p>
                    </span>
                </div>
                <div class="col-md-8 col-sm-12 text-end mt-3">
                    <div style="width: 100%;color: red">
                        <span class="fa fa-shield pull-right" style="color: #0069d9; font-size: 30px;margin-right:15px;"></span>
                        <span style="color: #0069d9;font-size: 15px;margin: 10px;">
                            Powered by <b>UIG</b>
                            <p>Phone : <b>www.uig.com</b></p>
                            <p>info@uig.com</p>
                        </span>
                    </div>
                </div>
