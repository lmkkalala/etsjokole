            ...
            <div class="row">
                <div id="menu-gauche" class="col-lg-3">
                    <ul class="list-menu list-unstyled" style="font-size: 20px;">
                        <li class="list-inline-item"><span style="color: red;font-size: 20px;" class="glyphicon glyphicon-asterisk"></span><a href="/openstock/views/home.php?link=<?= sha1("service_demande_add")?>&link_up=<?= sha1("home_service_demande")?>">Nouvelle demande</a></li>
                        <li class="list-inline-item"><span style="color: orange;font-size: 20px;" class="glyphicon glyphicon-list"></span><a href="/openstock/views/home.php?link=<?= sha1("service_demande_liste_demande_all")?>&link_up=<?= sha1("home_service_demande")?>">Liste de toutes les commandes</a></li>
                        <li class="list-inline-item"><span style="color: red;font-size: 20px;" class="glyphicon glyphicon-list"></span><span style="color: red;font-size: 20px;" class="glyphicon glyphicon-time"></span><a href="/openstock/views/home.php?link=<?= sha1("service_demande_liste_demande_encours")?>&link_up=<?= sha1("home_service_demande")?>">Liste des demandes encours</a></li>
                        <li class="list-inline-item"><span style="color: forestgreen;font-size: 20px;" class="glyphicon glyphicon-list"></span><span style="color: forestgreen;font-size: 20px;" class="glyphicon glyphicon-ok-circle"></span><a href="/openstock/views/home.php?link=<?= sha1("service_demande_liste_demande_finalise")?>&link_up=<?= sha1("home_service_demande")?>">Liste des demandes finalisées</a></li>
                        <li class="list-inline-item"><span style="color: darkslategray;font-size: 20px;" class="glyphicon glyphicon-list"></span><span style="color: darkslategray;font-size: 20px;" class="fa fa-gift"></span><a href="/openstock/views/home.php?link=<?= sha1("service_demande_fiche_biens_demande_all")?>&link_up=<?= sha1("home_service_demande")?>">Fiche de demandes par biens/produit</a></li>
                    </ul>
                </div>
                <style>
                    #menu-gauche {
