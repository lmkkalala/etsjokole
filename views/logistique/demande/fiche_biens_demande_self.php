        ...
        <div>
            ...
            <fieldset>
                ...
                <form method="post" action="../contollers/demande/demandeController.php">
                    ...
                    <button class="btn btn-info pull-right" style="margin-bottom: 10px;" type="submit" name="bt_encours_self_logistique">Voir les demandes encours</button>
                </form>
                <?php
                if ((isset($_GET['reponse'])) && ($_GET['reponse'] == sha1("get_encours_self_logistique"))) {
                    ?>
