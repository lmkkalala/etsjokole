                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="../contollers/demande/demandeController.php">
                                        ...
                                        <button type="submit" class="btn btn-primary" name="bt_view_for_biens_logistique"><span class="glyphicon glyphicon-file" style="color: white; font-size: 15px;margin-right: 5px;"></span></button>
                                    </form>
                                </td>
                            </tr>
                            <?php
