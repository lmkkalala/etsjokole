    ...
    <div class="panel panel-heading">
        ...
        <div class="row">
            <div class="col-md-6 col-12">
                <a style="font-size: 20px;" href='../views/home.php?link=<?= sha1("logistique_biens_add") . '&link_up=' . sha1("home_logistique_biens") ?>' class="btn btn-info w-100 mt-2"><span class="fa fa-refresh"></span> Refresh</a>
            </div>
            <div class="col-md-6 col-12">
            <a style="font-size: 20px;margin-right: 5px;" href='../views/home.php?link=<?= sha1("logistique_categorie_add").'&link_up='. sha1("home_logistique_categorie") ?>' class="btn btn-info w-100 mt-2"><span class="fa fa-plus"></span> New Group</a>
            </div>
        </div>
    </div>
