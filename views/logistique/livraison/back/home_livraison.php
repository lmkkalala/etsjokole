            ...
            <div class="row">
                <div id="menu-gauche" class="col-lg-3">
                    ...
                    <ul class="list-menu list-unstyled" style="font-size: 20px;">
                        ...
                        <li class="list-inline-item"><span style="color: red;font-size: 20px;" class="glyphicon glyphicon-list"></span><span style="color: red;font-size: 20px;" class="glyphicon glyphicon-time"></span><a href="/views/home.php?link=<?= sha1("service_distribution_liste_distribution_partielle")?>&link_up=<?= sha1("home_logistique_livraison")?>">Liste des distributions encours</a></li>
