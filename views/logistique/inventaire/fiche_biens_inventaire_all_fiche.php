            ...
            <fieldset>
                ...
                <form class="form-inline" method="POST" action="../contollers/inventaire/inventaireController.php">
                    <div class="row form-group-lg">
                        ...
                        <div class="col-6">
                        <button type="submit" class="btn btn-success" name="bt_search_for_biens_fiche"><span class="glyphicon glyphicon-search" style="color: white; font-size: 20px;margin-right: 5px;"></span> rechercher</button>
                        </div>                         
                    </div>
                </form>
            </fieldset>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="../contollers/inventaire/inventaireController.php">
                                        ...
                                        <button type="submit" class="btn btn-primary" name="bt_view_for_biens_fiche"><span class="glyphicon glyphicon-list" style="color: white; font-size: 15px;margin-right: 5px;"></span></button>
                                    </form>
                                </td>
                            </tr>
                            <?php
