...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12 text-start mt-1 mb-1">
            <h4 class="text-secodndary fw-bolder">BORDEREAU D'EXPEDITION</h4>
        </div>
            ...
            <form action="" method="post" id="FilterForm">
                <div class="row">
                    ...
                    <div class="col-md-2 col-12 mt-1">
                        ...
                        <button class="btn btn-secondary w-100 mt-2 text-white" type="submit"> <i class="fa fa-search"></i> Rechercher</button>
                    </div>
                    <div class="col-md-2 text-end">
                        <button class="btn btn-secondary w-100 mt-2 text-white" type="button"  data-bs-toggle="modal" data-bs-target="#staticBackdrop">
