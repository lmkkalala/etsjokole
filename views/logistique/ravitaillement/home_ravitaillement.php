            ...
            <div class="row">
                <div id="menu-gauche" class="col-md-2">
                    <ul class="list-menu list-unstyled" style="font-size: 20px;">
                        <li class="list-inline-item"><span style="color: green;font-size: 20px;" class="glyphicon glyphicon-asterisk"></span><a href="/views/home.php?link=<?= sha1("logistique_ravitaillement_add")?>&link_up=<?= sha1("home_logistique_ravitaillement")?>">New</a></li><br>
                        <li class="list-inline-item"><span style="color: black;font-size: 20px;" class="glyphicon glyphicon-book"></span><a href="/views/home.php?link=<?= sha1("logistique_ravitaillement_liste_ravitaillement_all_mois")?>&link_up=<?= sha1("home_logistique_ravitaillement")?>">All receipts</a></li>
                        <li class="list-inline-item"><span style="color: orange;font-size: 20px;" class="glyphicon glyphicon-list"></span><a href="/views/home.php?link=<?= sha1("logistique_ravitaillement_liste_ravitaillement_all")?>&link_up=<?= sha1("home_logistique_ravitaillement")?>">Find receipts</a></li>
                        <li class="list-inline-item"><span style="color: tomato;font-size: 20px;" class="glyphicon glyphicon-edit"></span><a href="/views/home.php?link=<?= sha1("logistique_ravitaillement_fiche_ravitaillement_fournisseur_all")?>&link_up=<?= sha1("home_logistique_ravitaillement")?>">Receipts per supplier</a></li>
                        ...
                        <li class="list-inline-item"><span style="color: red;font-size: 20px;" class="fa fa-tachometer"></span><a href="/views/home.php?link=<?= sha1("logistique_ravitaillement_liste_expired_fast")?>&link_up=<?= sha1("home_logistique_ravitaillement")?>">Expired Alert</a></li>
                    </ul>
                </div>
                <style>
                    #menu-gauche {
                ...
                <div class="col-md-10" style="padding: 10px;height: 80vh;overflow: auto;">
                    ...
                    if (isset($_GET['link'])) {
                        ...
                        }else if ($_GET['link']== sha1("logistique_ravitaillement_liste_ravitaillement_all_mois")) {
                            include 'logistique/ravitaillement/liste_ravitaillement_all_mois.php';
