            ...
            <div class="row">
                ...
                <form class="form-inline" method="POST" action="../contollers/ravitaillement/ravitaillementController.php">
                    <div class="row form-group-lg">
                        ...
                        <div class="col-md-6 col-12 mt-2">
                            <button type="submit" class="btn btn-secondary w-100" name="bt_search_for_biens"><span class="glyphicon glyphicon-search" style="color: white; font-size: 20px;margin-right: 5px;"></span> Rechercher</button>
                        </div>                          
                    </div>
                </form>
            </div>
                    ...
                    <table class="table table-bordered table-responsive-lg">
                        ...
                        <tbody>
                            ...
                            foreach ($biens as $bien) {
                                ...
                                <tr>
                                    <td><?= $n ?></td>
                                    <td><?= $bien['bId'].' / '.$bien['gDesignation'] ?></td>
