...
<div class="panel">
    <div class="panel panel-heading">
        ...
        <span class="glyphicon glyphicon-user" style="color: #0062cc; font-size: 30px;margin-right: 5px;"></span>
        <span class="h4">Payroll par employé</span>
    </div>
    <div class="panel panel-body col-lg-12">
        <div>
            ...
            if ((isset($_GET['reponse']) && ($_GET['reponse'] == (sha1("succes"))))) {
                ...
                <div class="alert alert-success">
                    <span class="glyphicon glyphicon-ok" style="font-size: 25px;margin-right: 5px;"></span><span>Success removing</span>
                </div>
                <?php
            }
            ?>
            ...
            ?>
            <fieldset>
                <legend><label class="control-label">Choisir un employé :</label></legend>
                <form class="form-horizontal" method="POST" action="../contollers/bulletin/bulletinController.php">
                    ...
                    <br>
                    <div class="input-group-lg">
                        <input class="btn btn-success" type="submit" name="bt_search_by_idaffectationservice" value="Select">
        ...
        <table class="table table-striped table-hover table-bordered table-responsive table-condensed">
            ...
            <tbody>
                ...
                if ((isset($_GET['use_affectationservice'])) && ($_GET['use_affectationservice'] != 0)) {
                    $bulletins = $bdbulletin->getBulletinByAffectationService($_GET['use_affectationservice']);
                } else {
                    $bulletins = $bdbulletin->getBulletinById(0);
                }
...
//                                                echo  $cumul_impot_IPR;
                            ...
                            <td>
                                <form class="form-horizontal" method="POST" action="../contollers/bulletin/bulletinController.php">
                                    ...
                                    <input type="hidden" name="tb_idbulletin" value="<?= $bulletin['id'] ?>">
                                    <input type="hidden" name="tb_use_affectationservice" value="<?= $_GET['use_affectationservice'] ?>">

                                    <button type="submit" class="btn btn-danger" name="bt_desactive_bulletin"><span class="fa fa-remove"></span></button>
