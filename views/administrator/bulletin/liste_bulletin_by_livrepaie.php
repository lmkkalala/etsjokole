...
<div class="panel">
    <div class="panel panel-heading">
        ...
        <span class="glyphicon glyphicon-calendar" style="color: orange; font-size: 30px;margin-right: 5px;"></span>
        <span class="h4">Payroll par mois / année</span>
    </div>
    <div class="panel panel-body col-lg-12">
        <div>
            ...
            ?>
            <fieldset>
                <legend><label class="control-label">Livre de paie :</label></legend>
                <form class="form-horizontal" method="POST" action="../contollers/bulletin/bulletinController.php">
                    ...
                    <br>
                    <div class="input-group-lg">
                        <input class="btn btn-success" type="submit" name="bt_search_by_idlivrepaie" value="Select">
        ...
        <table class="table table-striped table-hover table-bordered table-responsive table-condensed">
            ...
            <tbody>
                ...
                if ((isset($_GET['use_livrepaie'])) && ($_GET['use_livrepaie'] != 0)) {
                    $bulletins = $bdbulletin->getBulletinByLivrePaie($_GET['use_livrepaie']);
                } else {
