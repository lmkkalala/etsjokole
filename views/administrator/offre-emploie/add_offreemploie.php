...
<div class="panel">
    ...
    <div class="panel panel-body">
        <div>
            ...
            <form class="form-horizontal" method="POST" action="../contollers/offre-emploie/offreEmploieController.php">
                <div class="form-group-lg">
                    <div class="input-group-lg">
                        <label class="control-label">Numero :</label>
                        <input class="form-control" type="text" name="tb_numero" placeholder="Numero">
                    </div>
                    <div class="input-group-lg">
                        <label class="control-label">Libelle :</label>
                        <input class="form-control" type="text" name="tb_libelle" placeholder="Libelle">
                    </div>
                    <div class="input-group-lg">
                        <label class="control-label">Date de lancement :</label>
                        <input class="form-control" type="date" name="tb_datelancement">
                    </div>
                    <div class="input-group-lg">
                        <label class="control-label">Date de cloture :</label>
                        <input class="form-control" type="date" name="tb_datecloture">
                    </div>
                    <fieldset>
                        <legend></legend>
                        <div class="input-group-lg">
