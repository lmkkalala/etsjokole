...
<div class="panel">
    <div class="panel panel-heading">
        ...
        <span class="fa fa-list-ol" style="color: orange; font-size: 30px;margin-right: 5px;"></span>
        <span class="fa fa-ban" style="color: orange; font-size: 30px;margin-right: 5px;"></span>
        <span class="h4">List of for evermore desactivated</span>
    </div>
            ...
            <fieldset>
                ...
                <form class="form-inline" method="POST" action="../contollers/affectation-groupe/affectationGroupeController.php">
                    <div class="form-group-lg">
                        ...
                        <button type="submit" class="btn btn-success" name="bt_search_for_affectation_groupe_departement_desactive"><span class="glyphicon glyphicon-search" style="color: white; font-size: 30px;margin-right: 5px;"></span></button>
                    </div>
                </form>
            </fieldset>
            <fieldset>
                ...
                <table class="table table-bordered table-responsive-lg">
                    ...
                    <tbody>
                        ...
                        if ((isset($_GET['use_departement'])) && ($_GET['use_departement']!=0)) {
                            ...
                            $affectationgroupes = $bdaffectationgroupe->getAffectationGroupeAll();
                        }
                        
                        foreach ($affectationgroupes as $affectationgroupe) {      
                            if (($affectationgroupe['active'] == 0) && ($affectationgroupe['etatBlockage'] == 1)) {
                                $n++;
                                ?>
                                <tr>
