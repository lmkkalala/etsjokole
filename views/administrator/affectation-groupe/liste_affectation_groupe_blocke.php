...
<div class="panel">
    <div class="panel panel-heading">
        ...
        <span class="fa fa-ban" style="color: red; font-size: 30px;margin-right: 5px;"></span>
        <span class="h4">List of desactive's configuration</span>
    </div>
            ...
            <fieldset>
                ...
                <form class="form-inline" method="POST" action="../contollers/affectation-groupe/affectationGroupeController.php">
                    <div class="form-group-lg">
                        ...
                        <button type="submit" class="btn btn-success" name="bt_search_for_affectation_groupe_departement_blocke"><span class="glyphicon glyphicon-search" style="color: white; font-size: 30px;margin-right: 5px;"></span></button>
                    </div>
                </form>
            </fieldset>
            <fieldset>
...
//                            
                            if (($affectationgroupe['etatBlockage'] == 1) && ($affectationgroupe['active'] == 1)) {
