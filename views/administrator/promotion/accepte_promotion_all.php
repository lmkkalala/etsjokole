                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    if ($candidature['etatAcceptation'] == 1) {
                                        ?>
                                        <h4 style="color: forestgreen;">Accepted</h4>
                                        <?php
                                    } else {
                                        ?>
                                ...
                                <td>
                                    ...
                                    if ($candidature['etatAcceptation'] == 1) {
                                        ...
                                        <form method="post" action="../contollers/candidature/candidatureController.php">
                                            ...
                                            <button type="submit" name="bt_selection" class="btn btn-danger"><span class="glyphicon glyphicon-remove" style="color: white; font-size: 15px;margin-right: 5px;"></span></button>
                                        </form>
                                        <?php
                                    } else {
                                        ?>
                                        <form method="post" action="../contollers/candidature/candidatureController.php">
                                            ...
                                            <button type="submit" name="bt_selection" class="btn btn-success"><span class="glyphicon glyphicon-check" style="color: white; font-size: 15px;margin-right: 5px;"></span></button>
                                        </form>
                                        <?php
                                    }
                                    ?>
