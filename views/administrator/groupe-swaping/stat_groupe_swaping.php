            ...
            <fieldset>
                ...
                <fieldset >
                    ...
                    if ((isset($_GET['use_date1']))) {
                        ?>
                        <a style="font-size: 20px;" href='../views/administrator/groupe-swaping/pdf_stat_groupe_swaping_open_simple_second.php?use_date1=<?= $_GET['use_date1'] . '&use_date2=' . $_GET['use_date2'] . '&use_departement=' . $_GET['use_departement'] . '&use_service=' . $_GET['use_service'] ?>' class="btn btn-primary pull-left">Print Recap.</a>
                        <?php
                        ?>
                        <a style="font-size: 20px; margin-left: 10px;" href='../views/administrator/groupe-swaping/excel_recap_swaping.php?use_date1=<?= $_GET['use_date1'] . '&use_date2=' . $_GET['use_date2'] . '&use_departement=' . $_GET['use_departement'] . '&use_service=' . $_GET['use_service'] ?>' class="btn btn-success pull-left">Export in Excel</a>
                        <?php
                        ?>
                        <a style="font-size: 20px;" href='../views/administrator/groupe-swaping/excel_stat_groupe_swaping_open_simple.php?use_date1=<?= $_GET['use_date1'] . '&use_date2=' . $_GET['use_date2'] . '&use_departement=' . $_GET['use_departement'] . '&use_service=' . $_GET['use_service'] ?>' class="btn btn-success pull-right">Export in Excel</a>
                        <?php
                        ?>
                        <a style="font-size: 20px; margin-right: 10px;" href='../views/administrator/groupe-swaping/pdf_stat_groupe_swaping_open_with_name_simple.php?use_date1=<?= $_GET['use_date1'] . '&use_date2=' . $_GET['use_date2'] . '&use_departement=' . $_GET['use_departement'] . '&use_service=' . $_GET['use_service'] ?>' class="btn btn-primary pull-right">Print Meal Sheet</a>
                        <?php
