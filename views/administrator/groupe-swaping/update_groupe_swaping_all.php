                ...
                <table class="table table-bordered table-responsive-lg">
                    ...
                    <tbody>
                        ...
                        foreach ($groupeswapings as $groupeswaping) {
                            $n++;
                            ?>
                        <form class="form-horizontal" method="POST" action="../contollers/groupe-swaping/groupeSwapingController.php">
                            <div class="form-group-lg">
                                <tr>
                                    <td><?= $groupeswaping['id'] ?></td>
                                    <td><input class="form-control" type="text" name="tb_designation" value="<?= $groupeswaping['designation'] ?>"></td>
                                    <td><input class="form-control" type="number" name="tb_nombre_repas" value="<?= $groupeswaping['nombrerepas'] ?>"></td>
                                <input type = "hidden" name = "tb_idgroupeswaping" value ="<?= $groupeswaping['id'] ?>">
