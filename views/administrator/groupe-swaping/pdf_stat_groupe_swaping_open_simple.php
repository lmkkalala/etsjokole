...
foreach ($array_recette_categorie as $categories) {
    ...
    $pdf->Row(array(decode(" "), decode(" "), decode("Total : " . (" ")), decode(" "), decode($cumul_v1_departement), decode($cumul_v2_departement), decode($cumul_v3_departement), decode(" ")));
    $pdf->SetTextColor(0, 0, 0);
}
...
$pdf->Row(array(decode(" "), decode("Total : " . ""), decode(" "), decode(" "), decode($cumul_v1_categorie), decode($cumul_v2_categorie), decode($cumul_v3_categorie), decode(" ")));
$pdf->SetTextColor(0, 0, 0);
