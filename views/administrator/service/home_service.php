            ...
            <div class="row">
                <div id="menu-gauche" class="col-md-2">
                    <ul class="list-menu list-unstyled" style="font-size: 20px;">
                        ...
                        <li class="list-inline-item"><span style="color: orange;font-size: 20px;" class="glyphicon glyphicon-list"></span><a href="/views/home.php?link=<?= sha1("admin_service_liste_service_all")?>&link_up=<?= sha1("home_admin_service")?>">List</a></li><br>
